...
stop.addEventListener("click",
  ...
  if(soundEndflag === "1"){
    ...
    fireworks[0].style.backgroudColor = "rgba(0,0,0,0)";
    }else{
...
reset.addEventListener("click",
  ...
  if(soundEndflag === "1"){
    ...
    //backgroud
    const fireworks = document.getElementsByTagName("body");
    fireworks[0].style.backgroudImage = "";
    fireworks[0].style.backgroudColor = "rgba(233,168,227,0.6)";
  }
);
